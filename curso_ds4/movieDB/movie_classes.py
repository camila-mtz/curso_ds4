...
class SistemaCine:
    ...
    def obtener_peliculas_por_actor(self, nombre:str):
...
if __name__ == '__main__':
    archivo_actores = "curso_ds4/movieDB/datos/movies_db - actores.csv"
    archivo_peliculas = "curso_ds4/movieDB/datos/movies_db - peliculas.csv"
    archivo_relaciones = "curso_ds4/movieDB/datos/movies_db - relacion.csv"
    archivo_usuarios = "curso_ds4/movieDB/datos/movies_db - users.csv"
